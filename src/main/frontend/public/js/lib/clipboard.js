/**
 * 剪贴板 lib (UMD-lite): 浏览器挂 window.AgentClipboard, Node/Vitest 走 module.exports。
 *
...
(function (root) {
  ...
  async function copySegment(text) {
    ...
    try {
      ...
      if (root.ElementPlus) root.ElementPlus.ElMessage.success('已复制');
    } catch (e) {
      if (root.ElementPlus) root.ElementPlus.ElMessage.error('复制失败');
    }
  }
