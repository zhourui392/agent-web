 ...
 * 不受 in-DOM 自闭合限制。Vue / withBase 经 ES import; ElementPlus 仍走全局 (vendor, 待批次 5 迁移)。
 *
...
// 浏览器兼容: 挂 window.AdminShell / window.bootstrapAdminApp (未改 import 的消费者仍可用)
if (typeof window !== 'undefined') {
  window.AdminShell = AdminShell;
  window.bootstrapAdminApp = bootstrapAdminApp;
}