...
v-if="messageArtifact(message).sha256"
                      ...
                      <!-- 普通消息：Markdown 气泡 -->
                      <div
v-else class="harness-message-content harness-message-md md-body"
...
const {
  stageNames, stageLabels, runSummaries, selectedRun, selectedStageName,
  selectedStage, selectedAttempt, events, deployments, deploymentReadiness,
  snapshot, runtime, conversationMessages, conversationDraft, conversationFeed,
  conversationLoading, originalRequirement, apiAvailable, loadingRuns,
  loadingDetail, actionLoading, snapshotLoading, isMobile, createOpen,
  approvalOpen, approvalDecision, questionOpen, deploymentOpen, createForm,
  capabilityForm, approvalForm, previewOpen, previewContent, previewContentType,
  previewTitle, previewLoading, approvalArtifactContent, approvalArtifactContentType,
  approvalArtifactLoading, questionForm, deploymentForm, auditExpanded,
  openCapabilityPanel, answerDrafts, runFilter, runFilterOptions, runSearch,
  runSearchOpen, artifactCollapsed, filteredRuns, workingDirSuggestions,
  currentGates, gateFailures, stageArtifacts, stageApprovals, currentQuestions,
  unansweredQuestions, stageConversationMessages, runtimeBusy, canSendConversation,
  canValidateConversation, conversationHint, runtimeHint, finalReport,
  canStartStage, canRetryStage, canOperateRunningStage, canDecideApproval,
  canStartDeployment, loadRuns, loadRun, refreshSelected, selectStage,
  openCreate, createRun, startStage, retryStage, cancelRun, resolveSnapshot,
  confirmResolveSnapshot, launchRuntime, sendConversation, runGates,
  requestApproval, validateAndRequestApproval, openApproval, previewArtifact,
  submitApproval, openQuestion, submitQuestion, answerQuestion, approveDeployment,
  ...
  shortHash, reconciliationMessage
} = useHarness();
</script>