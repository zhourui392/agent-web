<template>
  <admin-shell active="settings" @ready="loadSettings">
    <template #header-actions>
      <el-button text :loading="loading" @click="loadSettings">刷新</el-button>
    </template>

    <div v-loading="loading" class="view-wrap" style="max-width: 760px;">
      <el-card shadow="never">
        ...
        <el-form label-position="top" size="default">
          ...
          <el-form-item>
            <el-button type="primary" :loading="savingAgentModels" data-test="save-settings" @click="saveAgentModels">保存默认模型</el-button>
          </el-form-item>
        </el-form>
      </el-card>
      ...
      <el-card shadow="never" style="margin-top: 16px;">
        ...
        <el-form label-position="top" size="default">
          ...
          <el-form-item label="允许的工作空间根目录（每行一个）">
            <el-input
v-model="form.workspaceRootsText" type="textarea" :rows="5"
          ...
          <el-form-item label="仅上传额外放行根目录（可选，每行一个）">
            <el-input
v-model="form.uploadRootsText" type="textarea" :rows="3"
          ...
          <el-form-item>
            <el-button
type="primary" :loading="savingWorkspaces" data-test="save-workspaces"
                       @click="saveWorkspaces">保存工作空间配置</el-button>
            <el-button
:loading="resettingWorkspaces" data-test="reset-workspaces"
                       @click="resetWorkspaces">恢复配置文件默认值</el-button>
          </el-form-item>
        </el-form>
      </el-card>
    </div>
